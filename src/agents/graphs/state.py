...
class RouterState(MessagesState):
    ...
    routing_decision: Optional[Literal["DIRECT", "USE_SHORT_TERM", "NONE", "SUMMARIZE_TODAY", "NEWS", "SEND_EMAIL"]] = None
    memory_used: Optional[Literal["direct", "short_term", "none", "fallback", "summary", "news", "email"]] = None
